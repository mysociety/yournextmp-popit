...
TWITTER_KEY = conf.get('TWITTER_KEY')
TWITTER_SECRET = conf.get('TWITTER_SECRET')
TWITTER_TOKEN = conf.get('TWITTER_TOKEN')
TWITTER_TOKEN_SECRET = conf.get('TWITTER_TOKEN_SECRET')
TWITTER_LIST_ID = conf.get('TWITTER_LIST_ID')
TWITTER_LIST_SLUG = conf.get('TWITTER_LIST_SLUG')
